...
import SidebarFiltersLeft from "@/components/SidebarFilters/SidebarFiltersLeft";
import SidebarFiltersRight from "@/components/SidebarFiltersRight/SidebarFiltersRight";
      ...
      .map((flight, index) => {
        try {
          ...
          const operatingCarrier =
            segments[0].operating?.carrierCode || segments[0].carrierCode;
          const airlineName =
            airlineNames[operatingCarrier] || operatingCarrier;
          const airlineLogo =
            airlineLogos[operatingCarrier] || getFallbackLogo(operatingCarrier);
            ...
            <div className="flex flex-wrap items-center gap-4">
              <div className="flex items-center bg-gray-100 rounded-full px-4 py-2">
                <span className="font-medium">
                  {filteredFlights[0].departure.airport}
                </span>
                <FiArrowRight className="mx-2 text-gray-500" />
                <span className="font-medium">
                  {filteredFlights[0].arrival.airport}
                </span>
              </div>
